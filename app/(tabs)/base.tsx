...
function makeStyles(colors: any) {
  return StyleSheet.create({
    ...
    searchInput: { flex: 1, fontSize: 16, color: colors.text, fontWeight: '600', outlineWidth: 0, padding: 0 },
    ...
    modalInput: { backgroundColor: colors.border, borderRadius: radius.input, paddingHorizontal: 14, paddingVertical: 12, fontSize: 16, color: colors.text, fontWeight: '600' },
